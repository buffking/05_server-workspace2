    ...
    <div class="outer">
        ...
        <form action="<%= contextPath %>/insert.th" id="enroll-form" method="post" enctype="multipart/form-data">
            ...
            <table align="center">
                ...
                <tr>
                    <th>상세이미지</th>
                    <td><img id="contentImg1" width="150" height="150" onclick="chooseFile(2);"></td>
                    <td><img id="contentImg2" width="150" height="150" onclick="chooseFile(3);"></td>
                    <td><img id="contentImg3" width="150" height="150" onclick="chooseFile(4);"></td>
                </tr>

            </table>

            <div id="file-area" style="display: none;">
                <!-- input[type=file name=file$ id=files$]*4 -->
